...
| `aiGuard:adversarial` | shared L1/L2 | 105 | block rate across attack techniques, plus false positives on legitimate rows | `accuracyGate` 0.85 **and** `precisionGate` 0.95 |
