...
export const env = createEnv({
	...
	server: {
		 ...
		 *
		 * SENTRY_AUTH_TOKEN is deliberately NOT declared either. It is a build-time
		 * credential read directly in next.config.ts; putting it in runtimeEnv would
		 * make it reachable from every server module that imports `env`.
		 */
